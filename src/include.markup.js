...
(function() {
  ...
  require('angular').module('includeMarkup', [require('./config'), require('./marked.config'), require('angular-marked'), require('./quirks'), require('./mobile.expand'), require('./language.picker')]).factory('ReadDataFile', [
    '$http',
    'Config',
    function($http,
    Config) {
    ...
    onclose);
          ...
          Locale.onChange(function() {
            ...
            if (scope.content.data && (scope.content.filename !== locFilename)) { //localized content, reload
              ...
              if (scope.isExpanded()) {
                ReadDataFile(localizeFilename(scope.content.filename),
    scope.content);
              }
            }
