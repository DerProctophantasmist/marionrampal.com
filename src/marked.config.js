...
(function() {
  ...
  require('angular').module('markedConfig', [require('angular-marked'), require('angular-ui-bootstrap'), require('./oEmbed'), require('./sections.ng'), require('./resource.file')]).config([
    'markedProvider',
    'EmbedUrl',
    'ResourceFile',
    ...
    function(Sections) {
      return markdownParam({
        nbrOfSectionsToLoad: Sections.nbrOfSectionsToLoad
      });
    }
